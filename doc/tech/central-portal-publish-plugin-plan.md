...
| `-PcentralPublish=true` | 本地/dry-run 启用 Central 严格 publication 配置，生成 sources/javadoc/POM/CentralStaging task；混淆时 sources 为占位 jar。不替代 `PublishLibraryRemoteTask` |
| `-PpomName=...` | `pomName` |
